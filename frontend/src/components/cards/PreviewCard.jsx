...
const PreviewCard = ({ data, index, onClose }) => {
  if (!data) return null;
  ...
  return (
    <div className="w-1/2 rounded-lg bg-gray overflow-hidden shadow-lg text-white hover:shadow-black cursor-pointer transition-shadow duration-300">
      <div className={`${bgClass} p-8  relative bg-contain bg-no-repeat bg-bottom bg-[url(/assets/img/cloudbg.png)]`}>
          ...
          <div className='grid grid-cols-2'>
            <button 
            onClick={onClose}
            className="absolute top-2 left-2 text-white text-xl cursor-pointer hover:text-gray-200"
            >
            <IoArrowBack />
            </button>

            <div className="flex items-center justify-center gap-2 mt-5 border-r">
